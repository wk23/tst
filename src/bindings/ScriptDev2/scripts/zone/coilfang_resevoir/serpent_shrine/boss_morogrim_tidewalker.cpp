...
struct MANGOS_DLL_DECL boss_morogrim_tidewalkerAI : public ScriptedAI
{
    boss_morogrim_tidewalkerAI(Creature* pCreature) : ScriptedAI(pCreature)
    {
        ...
        SpellEntry *TempSpell2 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_A7);
        if(TempSpell2)
            TempSpell2->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell3 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_A8);
        if(TempSpell3)
            TempSpell3->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell4 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_A9);
        if(TempSpell4)
            TempSpell4->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell5 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_A10);
        if(TempSpell5)
            TempSpell5->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell6 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_B6);
        if(TempSpell6)
            TempSpell6->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell7 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_B7);
        if(TempSpell7)
            TempSpell7->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell8 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_B8);
        if(TempSpell8)
            TempSpell8->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell9 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_B9);
        if(TempSpell9)
            TempSpell9->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell10 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_MURLOC_B10);
        if(TempSpell10)
            TempSpell10->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell11 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_GLOBULE_1);
        if(TempSpell11)
            TempSpell11->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell12 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_GLOBULE_1);
        if(TempSpell12)
            TempSpell12->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell13 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_GLOBULE_2);
        if(TempSpell13)
            TempSpell13->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
        SpellEntry *TempSpell14 = (SpellEntry*)GetSpellStore()->LookupEntry(SPELL_SUMMON_GLOBULE_3);
        if(TempSpell14)
            TempSpell14->EffectImplicitTargetA[0] =18;//TARGET_EFFECT_SELECT
